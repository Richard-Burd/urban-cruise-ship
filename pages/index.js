...
export default function Home() {
  return (
    <>
      ...
      <div className="lg:hidden pr-4 standard-font-1 standard-font-color-1 text-4xl">
        Welcome!
      </div>
      ...
      <div className="pb-6 standard-font-1 standard-font-color-1 text-2xl sm:text-4xl lg:text-6xl">
