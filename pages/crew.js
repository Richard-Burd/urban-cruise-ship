    ...
    <>
      ...
      <div className="columns-3 my-7 standard-font-3 text-justify text-lg">
        ...
        <div>
          ...
          YIMBY (Yes In My Back Yard) movement in San Francisco; advocating for
          a carbon fee and dividend with Citizens Climate Lobby; the Advocacy
          Chair for the Nashville, Tennessee chapter of the United Nations
          Association; lobbying the Davidson County Metro Government to improve
          its recycling program; lobbying with Tennessians for Fair Taxation for
          a state income tax in Tennessee; and active work in the Democratic
          Party in Nashville, Washington County, OR, and Seattle. In 2014,
          Michael was a fellow in East-West: The Art of Dialogue, a program of
          the Shafik Gabr Foundation, to foster ties between the United States
          and Egypt.
        </div>
        <div className="my-4"></div>
        <div>
      ...
      <div className="columns-3 my-7 standard-font-3 text-justify text-lg">
        ...
        <div className="my-4"></div>
        <div>
          Since 1975, John has been a designer, draftsman and illustrator in the
          fields of architecture, landscape architecture, civil engineering and
          planning, which have included some interior and graphic design, and
          structural, mechanical, plumbing, and electrical drawings. Previously,
          a variety of health-threatening factory work and odd jobs brought
          gratefulness for often-scarce design work opportunities and
        ...
        <div>
          ...
          voluntary closure of a large, financially-viable waste-to-energy plant
          with up-to-date air pollution control equipment, banning treated WTE
          ash as a loose construction fill material in many U.S. states, and
          establishing the first statewide “soil-based” compost quality
          standards as an incentive class. Doing so involved economic
          comparative analysis, risk assessment, conducting four pilot wet/dry
          source separation/processing systems, and touring over 200 facilities
          across the U.S. and Ontario. John has described how to achieve true
          zero-waste across entire municipal waste streams, including economic
          structures which enable this. Those include calculating and
          internalizing presently externalized disposal costs.
        </div>
        <div className="my-4"></div>
        <div>
      ...
      <div className="columns-3 my-7 standard-font-3 text-justify text-lg">
        ...
        <div>
          ...
          and Vegfest Coordinator.
        </div>
        <div className="my-4"></div>
        <div>
          Lee currently lives in Lansing Michigan with his wife and son. He has
          been an ethical vegan since January 2014. In February of 2019 Lee was
          elected to serve on the Board of Trustees of the Unity Spiritual
          Center of Lansing. In the fall of 2020 Lee graduated from the Lansing
          Citizens Academy, a program to learn about local government and the
          role of citizen involvement. Lee teaches yoga and tai chi at a local
          YMCA and enjoys seeing his students learn and grow through practice.
          Lee has always had a love for environmentalism and also enjoys trail
          running, yoga, tai chi, hiking, gardening, and reading.
        </div>
      </div>
      <center className="link-icon-set">
        <a
      ...
      <div className="columns-3 my-7 standard-font-3 text-justify text-lg">
        ...
        <div className="my-4"></div>
        <div>
          Richard has a B.A in Middle Eastern studies and a is a graduate of the
          Flatiron School&apos;s Full-Stack web development program. He began
          his career in California as an architectural draftsman where he helped
          design affordable housing projects built across the Los Angeles basin.
          He later worked as a technician and technical writer for drones used
          in agricultural surveys to improve crop yields and reduce input
          requirements.
        </div>
        <div className="my-4"></div>
        <div>
        ...
        <div>
          ...
          include rapid prototyping, (software/hardware) unmanned aviation, and
          social psychology
        </div>
      </div>
      <center className="link-icon-set">
      ...
      <div className="my-7 standard-font-3 text-justify text-lg">
        ...
        <div>
          ...
          Nashville/Davidson County activities for Recycling Advocates of Middle
          Tennessee.
        </div>
      </div>
      <br></br>
