  ...
  return (
    <>
      ...
      <div className="my-2 standard-font-3 standard-font-color-1 p-4 lg:p-0 text-justify text-lg">
        ...
        <div className="pb-6">
          <b>2021-Present:</b>&nbsp;As of August 13, 2023, 41 of our over-200 solutions contain at-least-mostly-full sets of estimates.&nbsp;  The combined totals are 
          $3.91 trillion U.S. dollars per year in costs, $5.98 trillion U.S. dollars per year in benefits, 8.77 billion tons of carbon dioxide-equivalents per year of greenhouse gas reduction, and 79 million square kilometers of habitat preserved.
        </div>
        <div className="pb-6">
