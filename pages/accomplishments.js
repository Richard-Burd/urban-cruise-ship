  ...
  return (
    <>
      ...
      <div className="my-2 standard-font-3 standard-font-color-1 p-4 lg:p-0 text-justify text-lg">
        ...
        <div className="pb-6">
          <b>2021-Present:</b>&nbsp;As of March 22, 2023, 23 of our over-200 solutions contain at-least-mostly-full sets of estimates.&nbsp;  The combined totals are 
          $4.879 trillion U.S. dollars per year in costs, $9.593 trillion U.S. dollars per year in benefits, 19.7 billion tons of carbon dioxide-equivalents per year of greenhouse gas reduction, and 79 million square kilometers of habitat preserved.
        </div>
        <div className="pb-6">
