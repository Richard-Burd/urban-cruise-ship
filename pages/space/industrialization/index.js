...
const focusAreaUrl = "industrialization";

const focusAreaName = findFocusAreaName(focusAreaUrl);

const focusAreaDescription = (
  <p>
    In this section, we review the prospects for commercialization and
    industrialization of space.
  </p>
);

const SpaceIndustrialization = () => {
  return (
    <>
      <FocusArea
        site={site}
...
export default SpaceIndustrialization;
