...
Demands not directly related to clean energy deployment, especially data centers for artificial intelligence [^32], should also be expected to increase worldwide electricity consumption.
...
It is estimated that the use of artificial intelligence for fault detection could reduce the duration of blackouts by 30-50% [^32].
...
[^15]: Lord, M. et al. ["Zero Carbon Industry Plan: Electrifying Industry"](https://apo.org.au/node/270186). Beyond Zero Emissions. September 2018.
...
[^32]: Spencer, T., Singh, S., D'Ambrosio, D., Hopewell, H., Jacamon, V., Martinos, A., Salmon, N., Wanner, B. et al. ["Energy and AI"](https://www.iea.org/reports/energy-and-ai). International Energy Agency. April 2025.
