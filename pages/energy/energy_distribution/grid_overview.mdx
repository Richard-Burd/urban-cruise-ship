...
See also our detailed analysis of [electrification](http://urbancruiseship.org/solution/energy/electrification) in the United States.
...
#### Potential new demands for electricity if electricity is used to replace fossil fuels or bioenergy in other portions of the economy, to substitute for land use in agriculture, remove atmospheric carbon dioxide via direct air capture, or desalinate water. For potential electricity demand from transportation, see our analysis of energy demand in [transportation](http://urbancruiseship.org/solution/energy/transpo_ghg) and [agriculture](http://urbancruiseship.org/solution/energy/ag_env) and replacement with [electric vehicles](http://urbancruiseship.org/solution/energy/transpo_cars), [hydrogen](http://urbancruiseship.org/solution/energy/hydrogen), [ammonia](http://urbancruiseship.org/solution/energy/ammonia), or [synthetic jet fuel](http://urbancruiseship.org/solution/energy/synfuels). See also our analyses of the [chemical industry](http://urbancruiseship.org/solution/energy/chemicals), [industrial heat](http://urbancruiseship.org/solution/energy/industrial_heat), [residential and commercial heat](http://urbancruiseship.org/solution/energy/heating), [intensive farming](http://urbancruiseship.org/solution/energy/ag_options) for discussion of cultured meat, power-to-food, and greenhosues, and [water usage](http://urbancruiseship.org/solution/energy/water_consumption) and [provision](http://urbancruiseship.org/solution/energy/water_treatment) for desalination. See Realmonte et al. [^12] for discussion of direct air capture.
...
With electricity demand growing rapidly, particularly with a potential shift toward electricity to power heavy industry and automobiles, there is an urgent need to shift the [generation](http://urbancruiseship.org/topic/energy/energy_production) toward less polluting sources.
...
The following are estimates of the costs of three strategies to enable the United States to supply 80% of electricity from wind and solar. The strategies are to overbuild renewables and [curtail](http://urbancruiseship.org/solution/energy/load_balancing) the excess, [high voltage](http://urbancruiseship.org/solution/energy/grid_design) [direct current](http://urbancruiseship.org/solution/energy/grid_design) cables to connect regional grids, and [energy storage](http://urbancruiseship.org/solution/energy/grid_storage).
