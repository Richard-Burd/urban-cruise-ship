...
#### The thick black line is the national electrification trends. The other lines represents the 50 states and Washington, D.C., which counts as a state for the purposes of EIA data.

The outliers include Washington, D.C. (56.1%) and Florida (46.9%) on the high end, and Alaska (8.0%) and Louisiana (18.5%) on the low end.
...
#### Electrification rates by the four major sectors over time. The EIA reports a fifth sector, electric power, but that sector does not contribute to the reported total energy consumption, nor does it use reported external electricity, and so it is omitted.
