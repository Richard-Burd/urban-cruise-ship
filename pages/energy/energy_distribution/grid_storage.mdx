...
## Storage Needs
High renewable energy scenarios may require large amounts of energy storage. The following are several estimates of storage requirements for scenarios of 80% wind and solar on the United States grid.

<ArticleImage image={"storage_needs.svg"} width={780} height={340} />
#### Estimated storage needed for the United States to produce 80% of electricity from wind and solar. Most estimates from Cebulla et al. [^8], with the high estimate from Shaner et al. [^20]. The estimate of Shaner et al. is based on a scenario of no curtailment of renewable energy and no high voltage direct current interconnections. Usage of curtailment or HVDC would reduce storage needs. The figure of 5.4 TWh is equal to about 12 hours of electricity usage in the United States.
...
<DynamicSolutionGraphic
  barChartTitle={""}
  barChartTitle2={"Electricity Storage Costs - Capacity"}
  rightSideAdd={0}
  leftSideAdd={0}
  mastheadToggle={""}
  chartType={"hideArrow"}
  mastheadText3={"MG, Mar. 27, 2025"}
  staticData={[
    {
      name: "Compressed Air",
      barlength: 39,
      displayedValue: "$39/kWh",
      site: "null",
    },
    {
      name: "Flywheel",
      barlength: 5399,
      displayedValue: "$5399/kWh",
      site: "null",
    },
    {
      name: "Hydrogen",
      barlength: 31,
      displayedValue: "$31/kWh",
      site: "null",
    },
    {
      name: "Lead Acid",
      barlength: 471,
      displayedValue: "$471/kWh",
      site: "null",
    },
    {
      name: "Lithium Ion",
      barlength: 802,
      displayedValue: "$802/kWh",
      site: "null",
    },
    {
      name: "Pumped Hydro",
      barlength: 80,
      displayedValue: "$80/kWh",
      site: "null",
    },
    {
      name: "Sodium Sulphur",
      barlength: 738,
      displayedValue: "$738/kWh",
      site: "null",
    },
    {
      name: "Supercapacitor",
      barlength: 13560,
      displayedValue: "$13,560/kWh",
      site: "null",
    },
    {
      name: "Vanadium Redox Flow",
      barlength: 760,
      displayedValue: "$760/kWh",
      site: "null",
    }
  ]}
/>
...
<DynamicSolutionGraphic
  barChartTitle={""}
  barChartTitle2={"Electricity Storage Costs - Power"}
  rightSideAdd={0}
  leftSideAdd={0}
  mastheadToggle={""}
  chartType={"hideArrow"}
  ...
  staticData={[
    {
      name: "Compressed Air",
      barlength: 871,
      displayedValue: "$871/kW",
      site: "null",
    },
    {
      name: "Flywheel",
      barlength: 641,
      displayedValue: "$641/kWh",
      site: "null",
    },
    {
      name: "Hydrogen",
      barlength: 5417,
      displayedValue: "$5417/kWh",
      site: "null",
    },
    {
      name: "Lead Acid",
      barlength: 675,
      displayedValue: "$675/kWh",
      site: "null",
    },
    {
      name: "Lithium Ion",
      barlength: 678,
      displayedValue: "$678/kWh",
      site: "null",
    },
    {
      name: "Pumped Hydro",
      barlength: 1129,
      displayedValue: "$1129/kWh",
      site: "null",
    },
    {
      name: "Sodium Sulphur",
      barlength: 657,
      displayedValue: "$657/kWh",
      site: "null",
    },
    {
      name: "Supercapacitor",
      barlength: 296,
      displayedValue: "$296/kWh",
      site: "null",
    },
    {
      name: "Vanadium Redox Flow",
      barlength: 829,
      displayedValue: "$829/kWh",
      site: "null",
    }
  ]}
/>
...
### Pumped Hydro
Although pumped hydro is established, there are novel hydro concepts under development. Coastal sites may be able to use the ocean as a reservoir. Variable-speed pumped hydro might be of greater value than conventional pumped hydro due to a greater ability to provide ancillary services [^1].
...
[^4]: Berry, G. ["Present and Future Electricity Storage for Intermittent Renewables"](http://www.c2es.org/docUploads/10-50_Berry.pdf). Lawrence Livermore National Laboratory. From workshop proceedings, "The 10-50 Solution: Technologies and Policies for a Low-Carbon Future." The Pew Center on Global Climate Change and the National Commission on Energy Policy. November 2004.
