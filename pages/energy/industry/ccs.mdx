...
For [industrial heat](http://urbancruiseship.org/solution/energy/industrial_heat) and process emissions from [major commodities](http://urbancruiseship.org/solution/energy/major_commodities), CCS may be the only economically viable tool to reduce emissions by more than 30% [^21].
...
Potential future uses of captured CO₂ include [methanol](http://urbancruiseship.org/solution/energy/methanol), [hydrocarbons](http://urbancruiseship.org/solution/energy/synfuels), [methane](http://urbancruiseship.org/solution/energy/methane), mineralization into building materials, working fluids for [coal](http://urbancruiseship.org/solution/energy/coal) and [geothermal](http://urbancruiseship.org/solution/energy/geothermal) power plants, fertilizing plant growth in [greenhouses](http://urbancruiseship.org/solution/energy/ag_options) [^1], feedstock for the chemical industry, and several niche industrial uses [^11], [^17].
