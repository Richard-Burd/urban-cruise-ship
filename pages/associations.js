...
const externalLinkIconStyles =
  "duration-300 ease-in-out hover:opacity-90 mx-2 opacity-40 active:translate-x-10 active:opacity-0 transition";
  ...
  return (
    <>
      ...
      <div className="px-4 lg:px-0">
        ...
        <div className="my-2 standard-font-3 standard-font-color-1 text-justify text-lg tracking-wide">
          <div>
            <b>Nashville Peace and Justice Center</b>, 2015. Urban Cruise Ship
            was an NPJC project in 2015.
          </div>
          <center>
            <a
              href="https://www.nashvillepeacejustice.org/"
        ...
        <div className="my-2 standard-font-3 standard-font-color-1 text-justify text-lg tracking-wide">
          <div>
            <b>Tennessee Environmental Council</b>, 2016. Full cost of solid
            waste disposal for Davidson County, TN.
          </div>
          <center>
            <a href="https://www.tectn.org/" target="_blank" rel="noreferrer">
              <Image
                className={externalLinkIconStyles}
                src={`/images/external-link-icons/home.svg`}
                alt={"Home icon"}
