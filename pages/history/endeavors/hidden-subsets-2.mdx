...
# 2. Energy Production & Efficiency

<DynamicSingleBarChart
  barChartTitle={`Ecology and Environment Endeavors - Benefit Over Cost Ratio`}
  ...
  titleText={0}
  titleAnchor={"end"}
  fetchDataFunc={() => endeavorBenefitOverCost(`/history/endeavors/subsets#energy-production-efficiency`)}
/>
<DynamicSingleBarChart
  barChartTitle={""}
  scale={"negative"}
...
<DynamicSingleBarChart
  barChartTitle={`Ecology and Environment Endeavors - Benefit minus Cost`}
  ...
  titleText={0}
  titleAnchor={"end"}
  fetchDataFunc={() => endeavorBenefitMinusCost(`/history/endeavors/subsets#energy-production-efficiency`)}
/>
<DynamicSingleBarChart
  barChartTitle={""}
  scale={"negative"}
...
<DynamicDoubleBarChart
  barChartTitle={"Ecology and Environment Endeavors - Cost and Efficiency"}
  barChartSubTitle={
  ...
  fetchDataFunc={
    /* 
      ...
      the chart.
    */
    () => endeavorCostEfficiencyComparison(0.08, `/history/endeavors/subsets#energy-production-efficiency`)
  }
/>
