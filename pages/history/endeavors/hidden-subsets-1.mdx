...
export const endeavorSubsetUrl = "/history/endeavors/subsets#ecology-environment";
export const endeavorTitle = "Ecology and Environment";
...
<DynamicDoubleBarChart
  ...
  fetchDataFunc={
    /* 
      This "0.08" input value below is the number times the lower bar
      ...
      the chart.
    */
    () => endeavorCostEfficiencyComparison(0.08, endeavorSubsetUrl)
  }
/>
