...
export const endeavorSubsetUrl = "/history/endeavors/subsets#transportation-infrastructure";
export const endeavorTitle = "Transportation Infrastructure";
...
<DynamicDoubleBarChart
  ...
  fetchDataFunc={
    /* 
      This "400" input value below is the number times the lower bar
      ...
      the chart.
    */
    () => endeavorCostEfficiencyComparison(400, endeavorSubsetUrl)
  }
/>
