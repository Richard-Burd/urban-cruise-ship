...
export const endeavorSubsetUrl = "/history/endeavors/subsets#pollution-regulations";
export const endeavorTitle = "Pollution Regulations";
...
<DynamicDoubleBarChart
  ...
  fetchDataFunc={
    /* 
      This "25" input value below is the number times the lower bar
      ...
      the chart.
    */
    () => endeavorCostEfficiencyComparison(25, endeavorSubsetUrl)
  }
/>
