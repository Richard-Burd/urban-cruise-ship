...
#### Losses by phase of production are compounding, meaning that the numbers are
the share of product that enters the given phase that is lost during the phase. Poorer
countries tend to have greater losses on the production side, while wealthier countries
has greater losses on the consumption side. Source: Gustavsson et al. [^4].
