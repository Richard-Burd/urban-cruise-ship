      ...
      <div className="pb-12">
        ...
        <AnimatePresence>
          {isVisible && (
            ...
            >
              <div className="this-is-the-dropdown-that-needs-to-be-style bg-slate-200 border border-slate-900 mx-16 solution-dropdown-elliptical-geometry solution-dropdown-shadow-geometry -translate-y-24">
