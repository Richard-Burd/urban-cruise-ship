...
endeavorData.sort((a, b) => {
  if (siteOrder[a.site] === siteOrder[b.site]) {
    ...
    return a.endeavor.localeCompare(b.endeavor);
  }
...
function EndeavorTable() {
  ...
  const columns = React.useMemo(
    () => [
      ...
      // We don't need this for now because Endeavors don't have sources, they have links
      // {
      //   Header: "Sources",
      //   accessor: "sources",
      // },
