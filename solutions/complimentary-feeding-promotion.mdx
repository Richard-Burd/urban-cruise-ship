...
Averted stunting is valued as a 30% increase in lifetime income. Averted mortality is valued using the Value of Statistical Life (VSL) at 1.55 times the respective GDP per capita of the target countries with this multiplier rising to 2.9 times per capita in 2090[^"1"].

Costs include the cost of the program itself, the time spent by mothers and caregivers on the education sessions, and the private cost of the additional food over the 18 month span. 24 million children are expected to be in the target group. The total cost of the promotion is expected to be US$61.50 per child for children in the lowest income target group, and US$18.50 per child for the highest income groups [^"1"].
