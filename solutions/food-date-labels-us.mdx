...
We recommend Congress pass legislation establishing a mandatory national date labeling system so that food is not discarded prior to its true expiration due to confusing labeling.
...
MMTCO2e reductions are calculated by multiplying tonnage of saved food by estimated greenhouse gas emissions of 4.4 metric tons per ton of food waste produced, which includes emissions associated with landfills, and the global warming potential of methane. [^"10"] [^"7"]


## Cost Calculations 


We use the FDA estimation on the annual cost of Nutritional Food labeling to give an estimate of the cost of a federal system. Due to the decreased complexity of a date label as opposed to nutritional facts, we use the low end of the range of cost estimates. These costs include relabeling, recordkeeping, and additional labeling. [^"12"] 



## Implementation

For manufacturers and retailers who choose to affix date labels, they should have the choice of selecting a quality label, a discard label, or none of the above. This system would still allow manufacturers to determine dates, which would decrease the cost of implementing the system since such determinations would be made locally. [^"7"]

Language would be restricted for the label type.
- Quality would use the wording “Best If Used By” [^"7"]
- Discard labels would use the wording “Use By” [^"7"]

Federal legislation should also prevent states from restricting the sale or donation of food that is past its “Best If Used By” date. [^"7"]
...
[^"1"]:  [Retail Survey 2021-22 | WRAP](https://wrap.org.uk/resources/report/retail-survey-2021-22#download-file). . . 
[^"2"]:  [Food Product Dating | Food Safety and Inspection Service](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/food-product-dating). . . 
[^"3"]:  [“Sell By” And “Best By” Dates on Food Are Basically Made Up—But Hard to Get Rid Of | Smart News](https://www.smithsonianmag.com/smart-news/sell-and-best-dates-food-are-basically-made-hard-get-rid-180950304/). . . 
[^"4"]:  [Dating Game Report](https://www.nrdc.org/sites/default/files/dating-game-report.pdf). . . 
[^"5"]:  [Uniform Date Labeling of Food May Address Food Waste](https://crsreports.congress.gov/product/pdf/IF/IF10398). . . 
[^"6"]:  [Are Food Date Labels a Waste of Food and Money? - FoodPrint](https://foodprint.org/blog/food-date-labels/). . . 
[^"7"]:  [DATE LABELS:](https://chlpi.org/wp-content/uploads/2013/12/date-labels-issue-brief_June-2019.pdf). . . 
[^"8"]:  [Waste Reduction Model (WARM)](archive.epa.gov/epawaste/conserve/tools/warm/pdfs/Plastics.pdf). EPA. 2015. 
[^"9"]:  [A ROADMAP TO REDUCE U.S. FOOD WASTE BY 20 PERCENT](https://refed.org/downloads/ReFED_Report_2016.pdf). . . 
...
[^"11"]:  [Consumer insight: date labels and storage guidance](https://wrap.org.uk/sites/default/files/2020-12/Consumer-insight-date-labels-and-storage-guidance.pdf). . . 
