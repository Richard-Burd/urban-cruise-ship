...
Cities choose to limit floor-area ratio (FAR) to manage such as to manage congestion [^"7"], [^"33"], among other reasons. However, such rules limit floor space and drive up costs through scarcity.
...
This proposal would allow three storey units in residential areas by right, would require that zoning allow at least six stories near commercial centers and public transit stops, and implement some other changes.
