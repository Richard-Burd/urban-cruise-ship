...
<b>Costs:</b> By reducing available road space, traffic congestion, if not mitigated by other means, would be a significant cost to a minimum lot size rollback. Traffic congestion cost the United States $87 billion in 2018. If the increase in costs is proportional to the increase in traffic density resulting from less road space and less driving, then the congestion costs are $703 million per year.
