...
<b>Description:</b> One of the most widespread zoning regulations is a minimum lot size, which requires that for every home, a minimum area is required. Such rules restrict the available amount of housing in a city and raise prices [^"8"], [^"17"], [^"36"]. It has been demonstrated that minimum lot size rules force larger developments than would otherwise be supplied by the market [^"6"]. We propose that these rules be eliminated.
...
<b>Benefits:</b> Under our assumptions, 2456 km<sup>2</sup> of land would be saved nationwide, resulting in a 1.6% increase in population density in single family zones.

We estimate that the average person living in a single family zone drives 28.8 miles per day [^"9"], that 60% of such residents drive, that the average cars has an economy of 24.4 miles per gallon [^"7"], and that a gallon of gasoline emits 8887 grams of CO<sub>2</sub> upon combustion [^"10"]. We estimate that the average driver would reduce driving by 0.8% to account for shorter distances between destinations. This would save 4.5 million tons of CO<sub>2</sub> emissions per year, valued at $224 million if CO<sub>2</sub> is priced at $50/ton.

By increasing the number of people able to live in metropolitan areas, minimum lot size rollbacks would have significant agglomeration benefits. Smaller lots would make room for housing to accomodate 3.9 million people and create an agglomeration benefit of $16.4 billion per year.
