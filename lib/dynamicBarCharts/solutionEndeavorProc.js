...
export function solutionEndeavorCostEfficiencyComparison() {
  ...
  for (let i = 0; i < combinedData.length; i++) {
    ...
    //       use different scales if we wish.  The "6.7" below is an arbitrary
    //       number that makes the BOTTOM BAR SEVERAL times larger than the
    //       top bar.  This is done to make the bottom bar more visible.
    itemCopy.barlengthTwo = itemCopy.barlengthTwo * 6.7;
