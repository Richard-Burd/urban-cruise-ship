...
export function endeavorBenefitMinusCost() {
...
export function endeavorCostEfficiencyComparison(efficiencyBarScaleFactor) {
  let processedEndeavorData = processCostEfficiencyComparison(endeavorData);
